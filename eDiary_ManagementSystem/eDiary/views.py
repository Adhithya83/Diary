...
def registration(request):
    ...
    if request.method == "POST":
        ...
        try:
            user = User.objects.create_user(username=emailid, password=Password, first_name=firstName,
                                            last_name=lastName)
...
def manageNotes(request):
    ...
    if request.method == "POST":
        ...
        try:
            Notes.objects.create(signup=signup, category=categoryid, noteTitle=noteTitle,
